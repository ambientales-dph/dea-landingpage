...
import { processTableMilestones, type MilestoneExtractionOutput } from '@/timeline/ai/flows/process-milestones-flow';
import type { Category, Milestone } from '@/timeline/types';
