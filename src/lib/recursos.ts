...
export const RECURSOS: Recurso[] = [
  ...
  { category: 'O', title: 'OBSERVATORIO CONURBANO', url: 'http://normas.ungs.edu.ar/' },
  ...
  { category: 'S', title: 'Sistema Nacional de Información Hídrica', url: 'https://snih.hidricosargentina.gob.ar/' },
